...
const LockScreen = ({ onUnlock }) => {
  ...
  return (
    <motion.div
      ...
      className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-gray-900 to-black flex flex-col items-center justify-between p-10 pt-16 pb-10 text-white z-[100]"
      onClick={onUnlock}
    >
