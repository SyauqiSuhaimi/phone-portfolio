      ...
      <div className="mb-6 bg-white dark:bg-zinc-900 rounded-3xl p-6 shadow-sm border border-black/5 dark:border-white/5 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center mb-6">
           <div className="w-20 h-20 bg-gray-100 dark:bg-zinc-800 rounded-full flex items-center justify-center mb-3 shadow-inner">
               <Smartphone size={32} className="text-gray-400 dark:text-gray-500" />
           </div>
           <h1 className="text-xl font-bold">Phone OS</h1>
           <p className="text-xs text-black/40 dark:text-white/40 font-mono uppercase tracking-widest">v{packageJson.version}</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 relative z-10">
           <div className="bg-gray-50 dark:bg-zinc-800/50 p-3 rounded-2xl flex flex-col items-center justify-center text-center gap-1 border border-black/5 dark:border-white/5">
                <span className="text-[10px] uppercase text-black/40 dark:text-white/40 font-bold tracking-wider">Build</span>
                <span className="text-xs font-semibold font-mono">{buildDate}</span>
           </div>
           <div className="bg-gray-50 dark:bg-zinc-800/50 p-3 rounded-2xl flex flex-col items-center justify-center text-center gap-1 border border-black/5 dark:border-white/5">
                <span className="text-[10px] uppercase text-black/40 dark:text-white/40 font-bold tracking-wider">Total Apps</span>
                <span className="text-xs font-semibold font-mono">{apps.length} Installed</span>
           </div>
        </div>
        ...
        <div className="mt-3 bg-gray-50 dark:bg-zinc-800/50 p-4 rounded-2xl border border-black/5 dark:border-white/5">
             <div className="flex items-center gap-2 mb-2">
                 ...
                 <span className="text-[10px] uppercase text-black/40 dark:text-white/40 font-bold tracking-wider">Tech Stack</span>
             </div>
             <div className="flex flex-wrap gap-1.5">
                 {["Next.js", "React", "TypeScript", "Tailwind"].map(t => (
                     <span key={t} className="text-[10px] px-2 py-1 bg-white dark:bg-white/10 rounded-md shadow-sm border border-black/5 dark:border-white/5 font-medium">
                         {t}
                     </span>
                 ))}
             </div>
